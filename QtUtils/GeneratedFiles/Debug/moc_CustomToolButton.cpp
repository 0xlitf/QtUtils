/****************************************************************************
** Meta object code from reading C++ file 'CustomToolButton.h'
**
...
#error "The header file 'CustomToolButton.h' doesn't include <QObject>."
...
const QMetaObject CustomToolButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_CustomToolButton.data,
      qt_meta_data_CustomToolButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
