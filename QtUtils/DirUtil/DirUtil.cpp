...
namespace QtUtils
{
	DirUtil::DirUtil(QObject* parent)
		: QObject(parent)
		, m_copyFileCount(0)
	{
	...
	QStringList DirUtil::findFiles(const QString& path,
	...
	int DirUtil::copyDirs(const QString& fromPath, const QString& toPath,
	...
	int DirUtil::copyFiles(const QStringList& files, const QString& toPath,
		bool overWrite)
	{
		int size = files.size();
		int count = 0;
	...
	void DirUtil::resetCopyFileCount()
	{
		m_copyFileCount = 0;
	}

	void DirUtil::doDirTree(const QString& fromPath, const QString& toPath,
		const QStringList& nameFilters, bool overWrite,
	...
	QString DirUtil::formatPath(const QString& path)
	{
